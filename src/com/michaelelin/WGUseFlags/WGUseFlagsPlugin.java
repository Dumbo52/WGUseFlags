...
public class WGUseFlagsPlugin extends JavaPlugin {

    private WGCustomFlagsPlugin wgCustomFlagsPlugin;
    private WorldGuardPlugin worldGuardPlugin;
    private WGUseFlagsListener listener;
    ...
    public void onEnable() {
        ...
        worldGuardPlugin = getPlugin("WorldGuard", WorldGuardPlugin.class);

        if (wgCustomFlagsPlugin != null && worldGuardPlugin != null) {
            listener = new WGUseFlagsListener(this, worldGuardPlugin);
